public class Date {
    ...
    Date(String fullDate, boolean isHoliday, String holidayName){
        this.day = fullDate.substring(0,2);
        this.month = fullDate.substring(3,5);
        this.year = fullDate.substring(6,10);
        this.isHoliday = isHoliday;
    ...
    Date(String day, String month, String year, boolean isHoliday){
        this.day = day;
        this.month = month;
        this.year = year;
        this.isHoliday = isHoliday;
    }
    Date(String day, String month, String year, boolean isHoliday, String holidayName){
        this.day = day;
        this.month = month;
        this.year = year;
        this.isHoliday = isHoliday;
